...
class GHTorrentDB(object):
    ...
    def get_selected_projects(self):
        projects = []
        query = "SELECT * FROM selected_projects_between_700_800_merged_prs_2 ORDER BY created_at"
    ...
    def export_selected_projects(self):
        query = "COPY (SELECT * FROM selected_projects_between_700_800_merged_prs ORDER BY created_at) TO STDOUT " \
